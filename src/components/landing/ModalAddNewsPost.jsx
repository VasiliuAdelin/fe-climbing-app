...
// import { createNewsPostAsync } from "../features/posts/newsPostSlice";

const ModalAddNewsPost = ({ handleOnClick }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const { imageLink, description, userImage, userName } = postValues;
    const payload = {
      imageLink,
      userImage,
      userName,
    ...
    // dispatch(createNewsPostAsync({ payload }));
  };

  return (
    <>
      <div className="bg-cover bg-center w-full h-screen md:h-screen relative flex flex-col justify-between mt-64 md:mt-0">
        <Container>
